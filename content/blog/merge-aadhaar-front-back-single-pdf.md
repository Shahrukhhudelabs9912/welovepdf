...
After merging, run the file through the [Compress PDF tool](/compress-pdf) and pick **High compression**. A typical Aadhaar PDF drops from ~1.5 MB to under 200 KB without becoming unreadable.
...
**❌ Submitting a sideways image.** Rotate before merging using the [Rotate PDF tool](/rotate-pdf).
...
**Can I merge more than two pages — e.g. Aadhaar + PAN + photo?**
Yes. Upload all the files in the [Merge PDF tool](/merge-pdf) in the order you want them, then merge. There's no limit for personal use.

**Does the tool work on iPhone / Android?**
Yes. The site works on mobile browsers. On iPhone, take the photos, share to Safari, and upload from Files. On Android, upload directly from Gallery.

**My PDF says "encrypted" — what now?**
Some scanner apps password-protect their PDFs. Use the [Unlock PDF tool](/unlock-pdf) first (you'll need the password), then merge.

**Can I rearrange pages after merging?**
Yes — use the [Organize PDF tool](/organize-pdf). Drag thumbnails to the order you want and apply.

## Summary

For one Aadhaar PDF for any government or banking application:

1. **Images → PDF:** [JPG to PDF](/jpg-to-pdf) for each side
2. **Combine:** [Merge PDF](/merge-pdf), front first, back second
3. **Shrink if needed:** [Compress PDF](/compress-pdf), High compression
