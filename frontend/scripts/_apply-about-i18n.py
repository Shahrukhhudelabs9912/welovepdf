...
EN_ABOUT = {
    ...
    "hero_description": "PDFOrca is a small, focused tool we built because we wanted PDF utilities that don't hide essential features behind paywalls or ship our files to opaque third parties. Today thousands of people use it every week.",
    ...
    "story_para_1": "PDFOrca began as a side project to scratch a personal itch. The big PDF sites all had the same pattern: free for two operations, then a paywall — or worse, low-quality output that nudged you toward upgrading.",
...
HI_ABOUT = {
    ...
    "hero_description": "PDFOrca एक छोटा, फ़ोकस्ड टूल है जिसे हमने इसलिए बनाया क्योंकि हम चाहते थे कि बेसिक PDF फीचर्स पेवॉल के पीछे न छुपे हों और हमारी फ़ाइलें किसी अंजान सर्वर पर न जाएँ। आज हज़ारों लोग इसे हर हफ़्ते इस्तेमाल करते हैं।",
    ...
    "story_para_1": "PDFOrca एक साइड प्रोजेक्ट के रूप में शुरू हुआ — एक निजी ज़रूरत को पूरा करने के लिए। बड़ी PDF साइट्स का एक ही पैटर्न था: दो ऑपरेशन तक मुफ़्त, फिर पेवॉल — या उससे भी बुरा, ख़राब क्वालिटी आउटपुट जो आपको अपग्रेड के लिए मजबूर करता था।",
